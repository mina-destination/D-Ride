...
export function TripDetailsPage() {
  ...
  // Row 1: Seat 1, Seat 2, [DRIVER]
  // Row 2: Seat 3, Seat 4, Seat 5
  // Row 3: Seat 6, Seat 7, Seat 8
  // Row 4: Seat 9, Seat 10, Seat 11
  // Row 5: Seat 12, Seat 13, Seat 14
  const seatLayout = [
    [1, 2, 'DRIVER'],
    [3, 4, 5],
    [6, 7, 8],
              ...
              <div style={{
                ...
                <div style={{ display: 'grid', gap: '14px' }}>
                  {seatLayout.map((row, rIdx) => (
                    <div key={rIdx} style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '14px', justifyItems: 'center', alignItems: 'center' }}>
                      {row.map((col, cIdx) => {
                        if (col === 'DRIVER') {
                          return (
                            <div 
                        ...
                        const content = (
                          <div 
                            ...
                            style={{ 
                              ...
                              boxShadow: selectedSeat === seatNum ? '0 0 10px var(--primary)' : 'none'
                            }}
                          >
                            <div>{seatNum}</div>
                            {isOccupied && <div style={{ fontSize: '7px', opacity: 0.8 }}>Booked</div>}
                            {isLocked && <div style={{ fontSize: '7px', opacity: 0.8 }}>Hold</div>}
                          </div>
                        );
